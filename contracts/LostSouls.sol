...
contract LostSouls is ERC721Enumerable, Ownable {
    ...
    constructor(
        ...
        address _t4,
        address _t5
        ) ERC721("Lost Souls Sanctuary", "LSS")  {
        setBaseURI(baseURI);
        t1 = _t1;
        t2 = _t2;
        t3 = _t3;
